  ...
  <button onClick={downloadAsDocx}>Download as DOCX</button>
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="event-form">
          ...
          />
          <label>Enter Participant Count:</label>
          <input
            type="number"
          ...
          />
          <label>No of students Accepted Jesus as their personal saviour</label>
          <input
            type="number"
          ...
          />
          <label>No of Non-Christian students Accepted Jesus as their personal saviour</label>
          <input
            type="number"
